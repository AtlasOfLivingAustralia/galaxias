...
person <- list(individualName = list(givenName = "Firstname", surName = "Surname"))

eml <- list(
  dataset = list(
    title = "Australia-wide photosynthetic trait dataset",
    creator = list(
  ...
  intellectualRights = "Organisation Name"
  )
)

write_eml(eml, here("output/eml/test"))
```
