...
The online version works via an API to ALA. Inevitably, this will take longer,
but also includes checks against the ALA system that are challenging within
R:
