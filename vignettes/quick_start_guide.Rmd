...
an existing research project. This is a fairly standard project folder 
structure, containing elements of a 
complete analytic workflow.
...
Running `build_archive()` also checks whether we have a 'schema' document (`meta.xml`) in our `data-publish` folder. This is a machine-readable `xml` document that describes the content of the archive's data files and their structure. The schema 
