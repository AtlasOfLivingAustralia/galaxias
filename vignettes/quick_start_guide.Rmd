...
for example, that your data looks like this:
...
can subset to only Darwin Core terms, and save it using `write_csv()`
...
Once you have edited the statement to reflect the information you want to
