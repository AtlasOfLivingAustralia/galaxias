...
Darwin Core terms are. We can find this out using `dwc_terms()`.
...
```
## # A tibble: 2 × 9
##   occurrenceID eventDate            decimalLatitude decimalLongitude scientificName   taxonRank
##          <int> <glue>                         <dbl>            <dbl> <chr>            <chr>    
## 1            1 2023-01-14T10:23:00Z           -35.3             149. Callocephalon f… species  
## 2            2 2023-01-15T11:25:00Z           -35.3             149. Eolophus roseic… species  
## # ℹ 3 more variables: individualCount <dbl>, recordedBy <chr>, basisOfRecord <chr>
```
...
## 1 Callocephal… Callocephalon … (Grant, 1803)          https://biodive… spec… exactMatch Animal…
## 2 Eolophus ro… Eolophus rosei… (Vieillot, 1817)       https://biodive… spec… exactMatch Animal…
