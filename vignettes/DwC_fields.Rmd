---
title: "Darwin Core fields"
author: "Martin Westgate"
date: '2024-01-19'
output:
  rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Darwin Core fields}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---
This is a brief introduction to the types of data suggested or required in 
Darwin Core archives, and what field names those are given in the Darwin Core
schema. It is not exhaustive.
...
eventDate is critical. Try `use_eventDate()`

If you detected your observations during a survey, then it is useful to provide
an `eventID` to group occurrences together; and perhaps consider an `event-core` 
dataset.

## Taxonomic data
It is best to include as much taxonomic information as you can. You can check
how your supplied names match those stored by a particular GBIF node using
`galah::search_taxa()`
...
dataset, these will need to be included in `occurrences.csv`. If your data are 
event-core, they will be in `events.csv`. You don't need to supply them in both
places.
